...
router.put('/:id', protect, authorize('customer'), validate(updateJobSchema), updateJob)
router.delete('/:id', protect, authorize('customer'), validate(cancelJobSchema), cancelJob)
